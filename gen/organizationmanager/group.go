...
func (c *GroupServiceClient) ListEffective(ctx context.Context, in *organizationmanager.ListEffectiveRequest, opts ...grpc.CallOption) (*organizationmanager.ListEffectiveResponse, error) {
	...
	return organizationmanager.NewGroupServiceClient(conn).ListEffective(ctx, in, opts...)
}
...
type GroupEffectiveIterator struct {
	...
	client  *GroupServiceClient
	request *organizationmanager.ListEffectiveRequest

	items []*organizationmanager.GroupMembershipInfo
}
...
func (it *GroupEffectiveIterator) Next() bool {
	...
	response, err := it.client.ListEffective(it.ctx, it.request, it.opts...)
	it.err = err
	if err != nil {
		return false
	}

	it.items = response.GroupMembershipInfo
	it.request.PageToken = response.NextPageToken
	return len(it.items) > 0
}
...
func (it *GroupEffectiveIterator) Take(size int64) ([]*organizationmanager.GroupMembershipInfo, error) {
	...
	var result []*organizationmanager.GroupMembershipInfo
