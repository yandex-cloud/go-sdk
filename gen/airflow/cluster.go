...
// ClusterServiceClient is a airflow.ClusterServiceClient with
...
func (c *ClusterServiceClient) Create(ctx context.Context, in *airflow.CreateClusterRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
...
func (c *ClusterServiceClient) Delete(ctx context.Context, in *airflow.DeleteClusterRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	conn, err := c.getConn(ctx)
	if err != nil {
		return nil, err
	}
...
func (c *ClusterServiceClient) ListAccessBindings(ctx context.Context, in *access.ListAccessBindingsRequest, opts ...grpc.CallOption) (*access.ListAccessBindingsResponse, error) {
	...
	return airflow.NewClusterServiceClient(conn).ListAccessBindings(ctx, in, opts...)
}
...
type ClusterOperationsIterator struct {
	...
	client  *ClusterServiceClient
	request *airflow.ListClusterOperationsRequest

	items []*operation.Operation
}

func (c *ClusterServiceClient) ClusterOperationsIterator(ctx context.Context, req *airflow.ListClusterOperationsRequest, opts ...grpc.CallOption) *ClusterOperationsIterator {
	var pageSize int64
	const defaultPageSize = 1000
	pageSize = req.PageSize
	if pageSize == 0 {
...
func (c *ClusterServiceClient) SetAccessBindings(ctx context.Context, in *access.SetAccessBindingsRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	...
	return airflow.NewClusterServiceClient(conn).SetAccessBindings(ctx, in, opts...)
}

// Start implements airflow.ClusterServiceClient
func (c *ClusterServiceClient) Start(ctx context.Context, in *airflow.StartClusterRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	conn, err := c.getConn(ctx)
	if err != nil {
		return nil, err
	}
	return airflow.NewClusterServiceClient(conn).Start(ctx, in, opts...)
}

// Stop implements airflow.ClusterServiceClient
func (c *ClusterServiceClient) Stop(ctx context.Context, in *airflow.StopClusterRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	conn, err := c.getConn(ctx)
	if err != nil {
		return nil, err
	}
	return airflow.NewClusterServiceClient(conn).Stop(ctx, in, opts...)
}

// Update implements airflow.ClusterServiceClient
func (c *ClusterServiceClient) Update(ctx context.Context, in *airflow.UpdateClusterRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	conn, err := c.getConn(ctx)
	if err != nil {
		return nil, err
	}
...
func (c *ClusterServiceClient) UpdateAccessBindings(ctx context.Context, in *access.UpdateAccessBindingsRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	...
	return airflow.NewClusterServiceClient(conn).UpdateAccessBindings(ctx, in, opts...)
}
