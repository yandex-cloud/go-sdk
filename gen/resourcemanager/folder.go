...
// BindAccessPolicy implements resourcemanager.FolderServiceClient
func (c *FolderServiceClient) BindAccessPolicy(ctx context.Context, in *access.BindAccessPolicyRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	...
	return resourcemanager.NewFolderServiceClient(conn).BindAccessPolicy(ctx, in, opts...)
}
...
// ListAccessPolicyBindings implements resourcemanager.FolderServiceClient
func (c *FolderServiceClient) ListAccessPolicyBindings(ctx context.Context, in *access.ListAccessPolicyBindingsRequest, opts ...grpc.CallOption) (*access.ListAccessPolicyBindingsResponse, error) {
	...
	return resourcemanager.NewFolderServiceClient(conn).ListAccessPolicyBindings(ctx, in, opts...)
}

type FolderAccessPolicyBindingsIterator struct {
	ctx  context.Context
	opts []grpc.CallOption
...
func (c *FolderServiceClient) FolderAccessPolicyBindingsIterator(ctx context.Context, req *access.ListAccessPolicyBindingsRequest, opts ...grpc.CallOption) *FolderAccessPolicyBindingsIterator {
	var pageSize int64
	const defaultPageSize = 1000
	pageSize = req.PageSize
	if pageSize == 0 {
	...
	return &FolderAccessPolicyBindingsIterator{
		ctx:      ctx,
		opts:     opts,
		client:   c,
		request:  req,
...
func (it *FolderAccessPolicyBindingsIterator) Next() bool {
	if it.err != nil {
		return false
	}
	if len(it.items) > 1 {
...
func (it *FolderAccessPolicyBindingsIterator) Take(size int64) ([]*access.AccessPolicyBinding, error) {
	if it.err != nil {
		return nil, it.err
	}
...
func (it *FolderAccessPolicyBindingsIterator) TakeAll() ([]*access.AccessPolicyBinding, error) {
	return it.Take(0)
}

func (it *FolderAccessPolicyBindingsIterator) Value() *access.AccessPolicyBinding {
	if len(it.items) == 0 {
		panic("calling Value on empty iterator")
	}
	return it.items[0]
...
func (it *FolderAccessPolicyBindingsIterator) Error() error {
	return it.err
}
...
// UnbindAccessPolicy implements resourcemanager.FolderServiceClient
func (c *FolderServiceClient) UnbindAccessPolicy(ctx context.Context, in *access.UnbindAccessPolicyRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	...
	return resourcemanager.NewFolderServiceClient(conn).UnbindAccessPolicy(ctx, in, opts...)
}
