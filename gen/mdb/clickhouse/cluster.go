...
// ListAccessBindings implements clickhouse.ClusterServiceClient
func (c *ClusterServiceClient) ListAccessBindings(ctx context.Context, in *access.ListAccessBindingsRequest, opts ...grpc.CallOption) (*access.ListAccessBindingsResponse, error) {
	...
	return clickhouse.NewClusterServiceClient(conn).ListAccessBindings(ctx, in, opts...)
}
...
// ListExternalDictionaries implements clickhouse.ClusterServiceClient
func (c *ClusterServiceClient) ListExternalDictionaries(ctx context.Context, in *clickhouse.ListClusterExternalDictionariesRequest, opts ...grpc.CallOption) (*clickhouse.ListClusterExternalDictionariesResponse, error) {
	conn, err := c.getConn(ctx)
	if err != nil {
		return nil, err
	}
	return clickhouse.NewClusterServiceClient(conn).ListExternalDictionaries(ctx, in, opts...)
}

type ClusterExternalDictionariesIterator struct {
	ctx  context.Context
	opts []grpc.CallOption
	...
	client  *ClusterServiceClient
	request *clickhouse.ListClusterExternalDictionariesRequest

	items []*config.ClickhouseConfig_ExternalDictionary
}

func (c *ClusterServiceClient) ClusterExternalDictionariesIterator(ctx context.Context, req *clickhouse.ListClusterExternalDictionariesRequest, opts ...grpc.CallOption) *ClusterExternalDictionariesIterator {
	var pageSize int64
	const defaultPageSize = 1000
	pageSize = req.PageSize
	if pageSize == 0 {
	...
	return &ClusterExternalDictionariesIterator{
		ctx:      ctx,
		opts:     opts,
		client:   c,
		request:  req,
...
func (it *ClusterExternalDictionariesIterator) Next() bool {
	if it.err != nil {
		return false
	}
	if len(it.items) > 1 {
	...
	response, err := it.client.ListExternalDictionaries(it.ctx, it.request, it.opts...)
	it.err = err
	if err != nil {
		return false
	}

	it.items = response.ExternalDictionaries
	it.request.PageToken = response.NextPageToken
	return len(it.items) > 0
}

func (it *ClusterExternalDictionariesIterator) Take(size int64) ([]*config.ClickhouseConfig_ExternalDictionary, error) {
	if it.err != nil {
		return nil, it.err
	}
	...
	var result []*config.ClickhouseConfig_ExternalDictionary
...
func (it *ClusterExternalDictionariesIterator) TakeAll() ([]*config.ClickhouseConfig_ExternalDictionary, error) {
	return it.Take(0)
}

func (it *ClusterExternalDictionariesIterator) Value() *config.ClickhouseConfig_ExternalDictionary {
	if len(it.items) == 0 {
		panic("calling Value on empty iterator")
	}
	return it.items[0]
...
func (it *ClusterExternalDictionariesIterator) Error() error {
	return it.err
}
...
// SetAccessBindings implements clickhouse.ClusterServiceClient
func (c *ClusterServiceClient) SetAccessBindings(ctx context.Context, in *access.SetAccessBindingsRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	...
	return clickhouse.NewClusterServiceClient(conn).SetAccessBindings(ctx, in, opts...)
}
...
// UpdateAccessBindings implements clickhouse.ClusterServiceClient
func (c *ClusterServiceClient) UpdateAccessBindings(ctx context.Context, in *access.UpdateAccessBindingsRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	...
	return clickhouse.NewClusterServiceClient(conn).UpdateAccessBindings(ctx, in, opts...)
}
