...
// ListAccessBindings implements mongodb.ClusterServiceClient
func (c *ClusterServiceClient) ListAccessBindings(ctx context.Context, in *access.ListAccessBindingsRequest, opts ...grpc.CallOption) (*access.ListAccessBindingsResponse, error) {
	...
	return mongodb.NewClusterServiceClient(conn).ListAccessBindings(ctx, in, opts...)
}
...
// SetAccessBindings implements mongodb.ClusterServiceClient
...
// UpdateAccessBindings implements mongodb.ClusterServiceClient
func (c *ClusterServiceClient) UpdateAccessBindings(ctx context.Context, in *access.UpdateAccessBindingsRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	...
	return mongodb.NewClusterServiceClient(conn).UpdateAccessBindings(ctx, in, opts...)
}
