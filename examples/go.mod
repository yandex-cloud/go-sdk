...
require (
	...
	github.com/yandex-cloud/go-sdk/services/compute v1.0.6
	github.com/yandex-cloud/go-sdk/services/lockbox v0.0.2
	...
	github.com/yandex-cloud/go-sdk/services/vpc v0.0.2
