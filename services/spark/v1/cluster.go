...
// ListAccessBindings is an operation of Yandex.Cloud Spark Cluster service.
func (c clusterClient) ListAccessBindings(ctx context.Context, in *access.ListAccessBindingsRequest, opts ...grpc.CallOption) (*access.ListAccessBindingsResponse, error) {
	...
	return spark.NewClusterServiceClient(connection).ListAccessBindings(ctx, in, opts...)
}
...
// SetAccessBindings is an operation of Yandex.Cloud Spark Cluster service.
// It returns an object which should be used to monitor the operation state.
func (c clusterClient) SetAccessBindings(ctx context.Context, in *access.SetAccessBindingsRequest, opts ...grpc.CallOption) (*ClusterSetAccessBindingsOperation, error) {
	...
	pb, err := spark.NewClusterServiceClient(connection).SetAccessBindings(ctx, in, opts...)
	if err != nil {
		return nil, err
	}
	op, err := sdkop.NewOperation(pb, &sdkop.Concretization{
...
// UpdateAccessBindings is an operation of Yandex.Cloud Spark Cluster service.
// It returns an object which should be used to monitor the operation state.
func (c clusterClient) UpdateAccessBindings(ctx context.Context, in *access.UpdateAccessBindingsRequest, opts ...grpc.CallOption) (*ClusterUpdateAccessBindingsOperation, error) {
	...
	pb, err := spark.NewClusterServiceClient(connection).UpdateAccessBindings(ctx, in, opts...)
	if err != nil {
		return nil, err
	}
	op, err := sdkop.NewOperation(pb, &sdkop.Concretization{
...
var (
	...
	ClusterListAccessBindings   = protoreflect.FullName("yandex.cloud.spark.v1.ClusterService.ListAccessBindings")
	ClusterSetAccessBindings    = protoreflect.FullName("yandex.cloud.spark.v1.ClusterService.SetAccessBindings")
	ClusterUpdateAccessBindings = protoreflect.FullName("yandex.cloud.spark.v1.ClusterService.UpdateAccessBindings")
