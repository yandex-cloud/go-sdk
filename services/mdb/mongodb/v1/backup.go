...
// Get is an operation of Yandex.Cloud MongoDB Backup service.
func (c backupClient) Get(ctx context.Context, in *mongodb.GetBackupRequest, opts ...grpc.CallOption) (*mongodb.Backup, error) {
	connection, err := c.connector.GetConnection(ctx, BackupGet, opts...)
	if err != nil {
		return nil, err
	}
	return mongodb.NewBackupServiceClient(connection).Get(ctx, in, opts...)
}

// List is an operation of Yandex.Cloud MongoDB Backup service.
func (c backupClient) List(ctx context.Context, in *mongodb.ListBackupsRequest, opts ...grpc.CallOption) (*mongodb.ListBackupsResponse, error) {
	connection, err := c.connector.GetConnection(ctx, BackupList, opts...)
	if err != nil {
		return nil, err
	}
	return mongodb.NewBackupServiceClient(connection).List(ctx, in, opts...)
}
...
func (o *BackupDeleteOperation) Metadata() *mongodb.DeleteBackupMetadata {
	return o.Operation.Metadata().(*mongodb.DeleteBackupMetadata)
}
...
// Delete is an operation of Yandex.Cloud MongoDB Backup service.
// It returns an object which should be used to monitor the operation state.
func (c backupClient) Delete(ctx context.Context, in *mongodb.DeleteBackupRequest, opts ...grpc.CallOption) (*BackupDeleteOperation, error) {
	connection, err := c.connector.GetConnection(ctx, BackupDelete, opts...)
	if err != nil {
		return nil, err
	}
	pb, err := mongodb.NewBackupServiceClient(connection).Delete(ctx, in, opts...)
	if err != nil {
		return nil, err
	}
	op, err := sdkop.NewOperation(pb, &sdkop.Concretization{
		...
		GetResourceID: func(metadata proto.Message) string {
			return metadata.(*mongodb.DeleteBackupMetadata).GetBackupId()
		},
		MetadataType: (*mongodb.DeleteBackupMetadata)(nil),
...
var (
	BackupGet             = protoreflect.FullName("yandex.cloud.mdb.mongodb.v1.BackupService.Get")
	BackupList            = protoreflect.FullName("yandex.cloud.mdb.mongodb.v1.BackupService.List")
	BackupDelete          = protoreflect.FullName("yandex.cloud.mdb.mongodb.v1.BackupService.Delete")
