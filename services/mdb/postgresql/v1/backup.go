...
// Get is an operation of Yandex.Cloud PostgreSQL Backup service.
func (c backupClient) Get(ctx context.Context, in *postgresql.GetBackupRequest, opts ...grpc.CallOption) (*postgresql.Backup, error) {
	connection, err := c.connector.GetConnection(ctx, BackupGet, opts...)
	if err != nil {
		return nil, err
	}
	return postgresql.NewBackupServiceClient(connection).Get(ctx, in, opts...)
}

// List is an operation of Yandex.Cloud PostgreSQL Backup service.
func (c backupClient) List(ctx context.Context, in *postgresql.ListBackupsRequest, opts ...grpc.CallOption) (*postgresql.ListBackupsResponse, error) {
	connection, err := c.connector.GetConnection(ctx, BackupList, opts...)
	if err != nil {
		return nil, err
	}
	return postgresql.NewBackupServiceClient(connection).List(ctx, in, opts...)
}
...
func (o *BackupDeleteOperation) Metadata() *postgresql.DeleteBackupMetadata {
	return o.Operation.Metadata().(*postgresql.DeleteBackupMetadata)
}
...
// Delete is an operation of Yandex.Cloud PostgreSQL Backup service.
// It returns an object which should be used to monitor the operation state.
func (c backupClient) Delete(ctx context.Context, in *postgresql.DeleteBackupRequest, opts ...grpc.CallOption) (*BackupDeleteOperation, error) {
	connection, err := c.connector.GetConnection(ctx, BackupDelete, opts...)
	if err != nil {
		return nil, err
	}
	pb, err := postgresql.NewBackupServiceClient(connection).Delete(ctx, in, opts...)
	if err != nil {
		return nil, err
	}
	op, err := sdkop.NewOperation(pb, &sdkop.Concretization{
		...
		GetResourceID: func(metadata proto.Message) string {
			return metadata.(*postgresql.DeleteBackupMetadata).GetBackupId()
		},
		MetadataType: (*postgresql.DeleteBackupMetadata)(nil),
...
var (
	BackupGet             = protoreflect.FullName("yandex.cloud.mdb.postgresql.v1.BackupService.Get")
	BackupList            = protoreflect.FullName("yandex.cloud.mdb.postgresql.v1.BackupService.List")
	BackupDelete          = protoreflect.FullName("yandex.cloud.mdb.postgresql.v1.BackupService.Delete")
