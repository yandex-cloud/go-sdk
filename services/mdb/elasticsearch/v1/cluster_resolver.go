...
func (r *clusterResolver) Run(ctx context.Context) error {
	...
	resp := r.client.Iterator(ctx, &elasticsearch.ListClustersRequest{
		FolderId: r.FolderID(),
...
func (r *clusterBackupsResolver) Run(ctx context.Context) error {
	...
	resp := r.client.BackupsIterator(ctx, &elasticsearch.ListClusterBackupsRequest{
...
func (r *clusterLogsResolver) Run(ctx context.Context) error {
	...
	resp := r.client.LogsIterator(ctx, &elasticsearch.ListClusterLogsRequest{
		ClusterId: r.ClusterID(),
		Filter:    sdkresolvers.CreateResolverFilter("name", r.Name),
		PageSize:  sdkresolvers.DefaultResolverPageSize,
	})
...
func (r *clusterOperationsResolver) Run(ctx context.Context) error {
	...
	resp := r.client.OperationsIterator(ctx, &elasticsearch.ListClusterOperationsRequest{
		ClusterId: r.ClusterID(),
...
func (r *clusterHostsResolver) Run(ctx context.Context) error {
	...
	resp := r.client.HostsIterator(ctx, &elasticsearch.ListClusterHostsRequest{
		ClusterId: r.ClusterID(),
