...
// Get is an operation of Yandex.Cloud Greenplum Backup service.
func (c backupClient) Get(ctx context.Context, in *greenplum.GetBackupRequest, opts ...grpc.CallOption) (*greenplum.Backup, error) {
	connection, err := c.connector.GetConnection(ctx, BackupGet, opts...)
	if err != nil {
		return nil, err
	}
	return greenplum.NewBackupServiceClient(connection).Get(ctx, in, opts...)
}

// List is an operation of Yandex.Cloud Greenplum Backup service.
func (c backupClient) List(ctx context.Context, in *greenplum.ListBackupsRequest, opts ...grpc.CallOption) (*greenplum.ListBackupsResponse, error) {
	connection, err := c.connector.GetConnection(ctx, BackupList, opts...)
	if err != nil {
		return nil, err
	}
	return greenplum.NewBackupServiceClient(connection).List(ctx, in, opts...)
}
...
func (o *BackupDeleteOperation) Metadata() *greenplum.DeleteBackupMetadata {
	return o.Operation.Metadata().(*greenplum.DeleteBackupMetadata)
}
...
// Delete is an operation of Yandex.Cloud Greenplum Backup service.
// It returns an object which should be used to monitor the operation state.
func (c backupClient) Delete(ctx context.Context, in *greenplum.DeleteBackupRequest, opts ...grpc.CallOption) (*BackupDeleteOperation, error) {
	connection, err := c.connector.GetConnection(ctx, BackupDelete, opts...)
	if err != nil {
		return nil, err
	}
	pb, err := greenplum.NewBackupServiceClient(connection).Delete(ctx, in, opts...)
	if err != nil {
		return nil, err
	}
	op, err := sdkop.NewOperation(pb, &sdkop.Concretization{
		...
		GetResourceID: func(metadata proto.Message) string {
			return metadata.(*greenplum.DeleteBackupMetadata).GetBackupId()
		},
		MetadataType: (*greenplum.DeleteBackupMetadata)(nil),
...
var (
	BackupGet             = protoreflect.FullName("yandex.cloud.mdb.greenplum.v1.BackupService.Get")
	BackupList            = protoreflect.FullName("yandex.cloud.mdb.greenplum.v1.BackupService.List")
	BackupDelete          = protoreflect.FullName("yandex.cloud.mdb.greenplum.v1.BackupService.Delete")
