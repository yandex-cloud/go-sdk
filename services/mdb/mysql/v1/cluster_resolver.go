...
func (r *clusterResolver) Run(ctx context.Context) error {
	...
	resp := r.client.Iterator(ctx, &mysql.ListClustersRequest{
		FolderId: r.FolderID(),
...
func (r *clusterLogsResolver) Run(ctx context.Context) error {
	...
	resp := r.client.LogsIterator(ctx, &mysql.ListClusterLogsRequest{
...
func (r *clusterOperationsResolver) Run(ctx context.Context) error {
	...
	resp := r.client.OperationsIterator(ctx, &mysql.ListClusterOperationsRequest{
		ClusterId: r.ClusterID(),
...
func (r *clusterBackupsResolver) Run(ctx context.Context) error {
	...
	resp := r.client.BackupsIterator(ctx, &mysql.ListClusterBackupsRequest{
		ClusterId: r.ClusterID(),
...
func (r *clusterHostsResolver) Run(ctx context.Context) error {
	...
	resp := r.client.HostsIterator(ctx, &mysql.ListClusterHostsRequest{
		ClusterId: r.ClusterID(),
