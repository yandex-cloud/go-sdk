...
// ImageClient provides methods for managing Image resources of Yandex.Cloud V1alpha.
...
// Get is an operation of Yandex.Cloud V1alpha Image service.
...
// List is an operation of Yandex.Cloud V1alpha Image service.
...
// Create is an operation of Yandex.Cloud V1alpha Image service.
...
// Update is an operation of Yandex.Cloud V1alpha Image service.
// It returns an object which should be used to monitor the operation state.
...
// Delete is an operation of Yandex.Cloud V1alpha Image service.
// It returns an object which should be used to monitor the operation state.
...
// ListOperations is an operation of Yandex.Cloud V1alpha Image service.
