...
// Get is an operation of Yandex.Cloud Baremetal PublicSubnet service.
...
// List is an operation of Yandex.Cloud Baremetal PublicSubnet service.
...
// Create is an operation of Yandex.Cloud Baremetal PublicSubnet service.
...
// Update is an operation of Yandex.Cloud Baremetal PublicSubnet service.
// It returns an object which should be used to monitor the operation state.
...
// Delete is an operation of Yandex.Cloud Baremetal PublicSubnet service.
// It returns an object which should be used to monitor the operation state.
...
// ListOperations is an operation of Yandex.Cloud Baremetal PublicSubnet service.
