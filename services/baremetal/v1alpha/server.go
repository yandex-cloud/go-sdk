...
// Get is an operation of Yandex.Cloud Baremetal Server service.
...
// List is an operation of Yandex.Cloud Baremetal Server service.
...
// Create is an operation of Yandex.Cloud Baremetal Server service.
...
// BatchCreate is an operation of Yandex.Cloud Baremetal Server service.
// It returns an object which should be used to monitor the operation state.
...
// Update is an operation of Yandex.Cloud Baremetal Server service.
// It returns an object which should be used to monitor the operation state.
...
// PowerOff is an operation of Yandex.Cloud Baremetal Server service.
// It returns an object which should be used to monitor the operation state.
...
// PowerOn is an operation of Yandex.Cloud Baremetal Server service.
// It returns an object which should be used to monitor the operation state.
...
// Reboot is an operation of Yandex.Cloud Baremetal Server service.
// It returns an object which should be used to monitor the operation state.
...
// Reinstall is an operation of Yandex.Cloud Baremetal Server service.
// It returns an object which should be used to monitor the operation state.
...
// StartProlongation is an operation of Yandex.Cloud Baremetal Server service.
// It returns an object which should be used to monitor the operation state.
...
// StopProlongation is an operation of Yandex.Cloud Baremetal Server service.
// It returns an object which should be used to monitor the operation state.
