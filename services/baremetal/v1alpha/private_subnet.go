...
// PrivateSubnetClient provides methods for managing PrivateSubnet resources of Yandex.Cloud V1alpha.
...
// Get is an operation of Yandex.Cloud V1alpha PrivateSubnet service.
...
// List is an operation of Yandex.Cloud V1alpha PrivateSubnet service.
...
// Create is an operation of Yandex.Cloud V1alpha PrivateSubnet service.
...
// Update is an operation of Yandex.Cloud V1alpha PrivateSubnet service.
// It returns an object which should be used to monitor the operation state.
...
// Delete is an operation of Yandex.Cloud V1alpha PrivateSubnet service.
// It returns an object which should be used to monitor the operation state.
...
// ListOperations is an operation of Yandex.Cloud V1alpha PrivateSubnet service.
